...
def tirada ():
    ...
    while cuatro_en_raya != True:
        ...
        print('')
        print (tablero[0][0], tablero[0][1], tablero[0][2], tablero[0][3], tablero[0][4], tablero[0][5])
        print (tablero[1][0], tablero[1][1], tablero[1][2], tablero[1][3], tablero[1][4], tablero[1][5])
        print (tablero[2][0], tablero[2][1], tablero[2][2], tablero[2][3], tablero[2][4], tablero[2][5])
        print (tablero[3][0], tablero[3][1], tablero[3][2], tablero[3][3], tablero[3][4], tablero[3][5])
        print (tablero[4][0], tablero[4][1], tablero[4][2], tablero[4][3], tablero[4][4], tablero[4][5])
        print (tablero[5][0], tablero[5][1], tablero[5][2], tablero[5][3], tablero[5][4], tablero[5][5])
        print (tablero[6][0], tablero[6][1], tablero[6][2], tablero[6][3], tablero[6][4], tablero[6][5])
